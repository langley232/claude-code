...
class MicrosoftOAuthHandler {
    ...
    startMicrosoftAuth() {
        ...
        if (window.location.hostname === 'localhost') {
            console.log('🧪 Local development detected - using demo authentication');
            this.simulateLocalAuth();
            return;
        }
        
        // Direct OAuth flow without warning dialog (restoring previous working behavior)
    ...
    getAccessToken() {
        return this.state.accessToken || 'microsoft_mock_token_' + Date.now();
    }
}
